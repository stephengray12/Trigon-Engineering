...
export default function About() {
  ...
  const paragraphs = [
    `Founded with dedication to delivering precision-engineered solutions, Trigon Engineering is your trusted partner for high-quality wet-process equipment. Headquartered in North Little Rock, Arkansas, we serve as a manufacturer’s representative, offering an extensive range of robust industrial pumps, valves, and complementary process equipment tailored to meet the unique demands of your operations.`,

...
const ContactFormModal = ({ isOpen, onClose }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999]" aria-hidden={!isOpen}>
      ...
      {/* Wrapper: centers modal & allows vertical scroll on small screens */}
      <div className="relative z-10 flex items-start justify-center min-h-full p-4 overflow-y-auto">
        {/* Modal */}
        <div
          ref={modalRootRef}
          role="dialog"
          ...
          className="relative w-full max-w-md rounded-2xl border border-white/10 bg-neutral-900 text-white shadow-2xl overflow-y-auto max-h-[calc(100vh-2rem)]"
        >
          <button
            ref={closeBtnRef}
            onClick={onClose}
